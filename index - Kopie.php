...
<head>
    ...
    <!-- New -- link for Popup-->
    <link href="//cdn.rawgit.com/noelboss/featherlight/1.7.13/release/featherlight.min.css" type="text/css" rel="stylesheet" title="Featherlight Styles" />
...
<!--            <div id="id01" class="w3-modal">
                <div class="w3-modal-content">
                    ...
                    <header class="w3-container w3-teal">
                        ...
                        <h2 style="align-content: center">Terms and Conditions</h2>
                    </header>
                    ...
                    <div id="download_after">
                        <a class="btn btn-lg btn-success" href="https://github.com/noelboss/featherlight/archive/master.zip" style="align-self: end">
                            <i class="glyphicon glyphicon-arrow-down"></i>
                            Download
                        </a>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        function display_block( $file )
                        {
                            ...
                            $rtn .= "	<div class=\"name\">\n";
                            $rtn .= "<a href=\"#\" data-featherlight=\"#disclaimer\">Download</a>";
                            //$rtn .= " <button onclick=\"document.getElementById('id01').style.display='block'\" class=\"w3-button w3-black\" >Download</button>";
